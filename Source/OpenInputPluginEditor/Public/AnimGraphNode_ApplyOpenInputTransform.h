...
#include "AnimGraphNode_ApplyOpenInputTransform.generated.h"

UCLASS(MinimalAPI)
class UAnimGraphNode_ApplyOpenInputTransform : public UAnimGraphNode_SkeletalControlBase
{
	GENERATED_UCLASS_BODY()

	UPROPERTY(EditAnywhere, Category = Settings)
	FAnimNode_ApplyOpenInputTransform Node;
